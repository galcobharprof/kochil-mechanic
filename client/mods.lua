...
RegisterNUICallback('previewMod', function(data, cb)
    ...
    if data.isColor then
        ...
        if data.paintType == 'primary' then SetVehicleColours(currentVehicle, data.colorId, s)
        elseif data.paintType == 'secondary' then SetVehicleColours(currentVehicle, p, data.colorId)
